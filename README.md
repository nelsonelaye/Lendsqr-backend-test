...
| POST        | /api/user/[userId]/fund-wallet    | Allows authorized user with [userId] to fund their wallet with cash       |
| POST        | /api/user/[userId]/withdraw-funds | Allows authorized user with [userId] to withdraw funds from their balance |
| POST        | /api/user/[userId]/transfer-funds | Allows authorized user with [userId] to transfer funds to another user    |
